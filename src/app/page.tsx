                ...
                <div className="collapsible-wrapper mt-6">
                    ...
                    <details className="text-details">
                        ...
                        <div className="text-container">
                            ...
                            <p>
                                Варто зазначити, що якщо ви бажаєте дійсно глибоких змін, то необхідно розуміти, що швидко навчитися «жити по-новому» — буде складно. Адже буде необхідна систематична терапія. Також ви завжди маєте памʼятати, що тривалість терапії визначається виключно вами і вашим власним бажанням.
                            </p>
                        </div>
                    </details>
